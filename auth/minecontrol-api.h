...
typedef enum {
    ...
    m_err = -4, /* another error occured and the input operation failed */
    _m_first = 0,
    m_chat = _m_first,
    m_serverchat,
    m_serverstart,
...
#define MESSAGE_TESTBLOCK_SUCCESS "testblock-success"
#define MESSAGE_TESTBLOCK_FAILURE "testblock-failure"
